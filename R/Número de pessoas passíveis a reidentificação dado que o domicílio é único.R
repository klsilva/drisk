...
for (i in 1:length(regiao_cod_mun_lista)){
  aux <- sum(regiao_cod_mun_lista[[i]]$n_pess) 
...
write.xlsx(tamanho_regiao_cod_mun_df,file="tamanho_npess_regiao_cod_mun_df.xlsx")
...
for (i in 1:length(regiao_apond_lista)){
  aux <- sum(regiao_apond_lista[[i]]$n_pess) 
...
write.xlsx(tamanho_regiao_apond_df,file="tamanho_npess_regiao_apond_df_dom.xlsx")
...
for (i in 1:length(meso_unicidade_UF_lista)){
  aux <- sum(meso_unicidade_UF_lista[[i]]$n_pess) 
  tamanho_meso_UF[[length(tamanho_meso_UF)+1]] <- aux
}

tamanho_meso_UF_df <- data.frame(UF=UFS,Unicidade=tamanho_meso_UF)

write.xlsx(tamanho_meso_UF_df,file="tamanho_npess_meso_UF_df_dom.xlsx")
...
for (i in 1:length(regiao_meso_lista)){
  aux <- sum(regiao_meso_lista[[i]]$n_pess) 
...
write.xlsx(tamanho_regiao_meso_df,file="tamanho_npess_regiao_meso_df_dom.xlsx")
...
for (i in 1:length(micro_unicidade_UF_lista)){
  aux <- sum(micro_unicidade_UF_lista[[i]]$n_pess) 
  tamanho_micro_UF[[length(tamanho_micro_UF)+1]] <- aux
}

tamanho_micro_UF_df <- data.frame(UF=UFS,Unicidade=tamanho_micro_UF)

write.xlsx(tamanho_micro_UF_df,file="tamanho_npess_micro_UF_df_dom.xlsx")
...
for (i in 1:length(regiao_micro_lista)){
  aux <- sum(regiao_micro_lista[[i]]$n_pess) 
...
write.xlsx(tamanho_regiao_micro_df,file="tamanho_npess_regiao_micro_df_dom.xlsx")
...
for (i in 1:length(rm_unicidade_UF_lista)){
  aux <- sum(rm_unicidade_UF_lista[[i]]$n_pess) 
  tamanho_rm_UF[[length(tamanho_rm_UF)+1]] <- aux
}

tamanho_rm_UF_df <- data.frame(UF=UFS,Unicidade=tamanho_rm_UF)

write.xlsx(tamanho_rm_UF_df,file="tamanho_npess_rm_UF_df_dom.xlsx")
